...
COPY demo_staging_version_A FROM 'D:\Current\all_version_A_demo_data_with_filename' WITH DELIMITER E'$' CSV HEADER QUOTE E'\b' ;
...
COPY demo_staging_version_B FROM 'D:\Current\all_version_B_demo_data_with_filename' WITH DELIMITER E'$' CSV HEADER QUOTE E'\b' ;

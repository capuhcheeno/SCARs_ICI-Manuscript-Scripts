...
on scdm.standard_concept_id = c.concept_id::integer
...
and concept_id_1::integer in (select standard_concept_id from cte1)
)
update standard_combined_drug_mapping scdm 
set standard_concept_id = concept_id_2::integer -- update the standard concept id to the standard concept id we found
from cte2
where scdm.standard_concept_id::integer = cte2.concept_id_1::integer;
...
set standard_concept_id = concept_id_2::integer -- update the standard concept id to the standard concept id we found
from cte2
where scdm.standard_concept_id = cte2.concept_id_1::integer;
...
and c1.concept_id::integer in (select standard_concept_id from cte1)
)
update standard_combined_drug_mapping scdm
set standard_concept_id = concept_id_2::integer -- update the standard concept id to the standard concept id we found
from cte2
...
inner join cdmv5.concept b
on a.concept_id_1::integer = b.concept_id::integer
inner join cdmv5.concept c
on a.concept_id_2::integer = c.concept_id::integer
and b.vocabulary_id = 'RxNorm'
and c.vocabulary_id = 'RxNorm'
where a.relationship_id = 'Concept replaced by'
and a.concept_id_1::integer in (select standard_concept_id from cte1)
),
cte3 as 
(WITH cte_filtered AS (
    ...
    INNER JOIN cdmv5.concept_relationship cr
        ON cte2.concept_id_2::integer = cr.concept_id_1::integer   
    INNER JOIN cdmv5.concept b
        ON cr.concept_id_2::integer = b.concept_id::integer
...
update standard_combined_drug_mapping scdm 
set standard_concept_id = b.concept_id::integer -- update the standard concept id to the standard concept id we found
from cte3
inner join cte2
...
from cdmv5.concept_relationship  cr
left outer join cdmv5.concept a
on cr.concept_id_1::integer = a.concept_id::integer
and a.vocabulary_id = 'RxNorm'
inner join cdmv5.concept b
on cr.concept_id_2::integer = b.concept_id::integer
and b.vocabulary_id = 'RxNorm'
...
inner join cdmv5.concept c
on a.standard_concept_id::integer = c.concept_id::integer
